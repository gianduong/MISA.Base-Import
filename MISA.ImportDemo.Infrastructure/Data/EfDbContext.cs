...
namespace MISA.ImportDemo.Infrastructure.Data
{
    public partial class EfDbContext : DbContext
    {
        ...
        public virtual DbSet<CustomerRecommend> CustomerRecommend { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasComment("nhom khach hang");
            ...
            {
                entity.HasComment("Bảng danh sách khách hàng");

                entity.HasIndex(e => e.CustomerGroupId)
                    .HasName("FK_Customer_CustomerGroupId");

                entity.HasIndex(e => e.EthnicId)
                    .HasName("FK_Customer_EthnicId");

                entity.HasIndex(e => e.NationId)
                    .HasName("FK_Customer_NationId");
                ...
                entity.Property(e => e.Gender).HasColumnType("int(2)");
                ...
                entity.HasOne(d => d.Ethnic)
                    ...
                    .HasConstraintName("FK_Customer_EthnicId");

                entity.HasOne(d => d.Nationality)
                    .WithMany(p => p.Customer)
                    .HasForeignKey(d => d.NationId)
                    .HasConstraintName("FK_Customer_NationId");
            });
            modelBuilder.Entity<CustomerRecommend>(entity =>
            {
                entity.HasIndex(e => e.CustomerCode)
                    .HasName("FK_CustomerRecommend_CustomerCode");

                entity.HasIndex(e => e.FullName)
                    .HasAnnotation("MySql:FullTextIndex", true);

                entity.Property(e => e.CustomerRecommendId)
                    .HasColumnName("CustomerRecommendId")
                    .ValueGeneratedNever()
                    .HasCharSet("utf8")
                    .HasCollation("utf8_general_ci");
                ...
                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.CustomerRecommend)
                    .HasForeignKey(d => d.CustomerId)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK_CustomerRecommend_CustomerId");
            });
            // ---------------------------employee-----------------------------------------
